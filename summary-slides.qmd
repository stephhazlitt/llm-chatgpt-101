...
![](images/fail.png){.absolute top="75"}

## Beware: Confident When Wrong 🤖 

![](images/fail-again.png){.absolute top="75"}
...
## Self Criticism & Self Refine Prompting
...
![](images/bcstats.png){.absolute top="50" left="250" height="800"}
